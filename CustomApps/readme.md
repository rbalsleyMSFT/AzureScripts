...
2. Right-Click the Upload-Apps.ps1 file and select Properties. Select Unblock and click OK.

   ![1730941714811](image/readme/1730941714811.png)
3. Prepare the content folder. In this example we're using a c:\source folder. In this folder copy in your applications and the apps.json, Download-Apps.ps1, and Install-Apps.ps1 files.
